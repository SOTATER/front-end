...
<div class="Header">
  ...
  <div class="Profile">
    <div class="Information">
      <span class="Name">욕하는놈코로나19</span>
      <div class="Rank">
    ...
    <div class="Buttons">
      <button
        ...
        onclick="$.OP.GG.summoner.renewBtn.start(this, '84764513');"
      ...
      <button
        id="top_tiergraph"
        class="Button SemiRound White"
        onclick="$.OP.GG.summoner.openLpHistoryGraph('욕하는놈코로나19', '#ExtraView');"
        >티어 그래프</button
      >
    </div>
